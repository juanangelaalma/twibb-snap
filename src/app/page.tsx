    ...
    <main>
      <div className="px-6 py-12 h-screen flex flex-col justify-start items-center mx-auto">
        <div className="mb-6 w-[400px] h-[400px] relative rounded-lg overflow-hidden" id="resultComponent">
          <NextImage style={{ opacity: isRepositioning ? 0.5 : 1 }} className="top-0 left-0 z-10 w-full md:max-w-[500px] max-auto absolute" src='/assets/twibbon.png' width={500} height={500} alt="Twibbon" />
